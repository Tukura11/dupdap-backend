...
import { adminAlertConfig } from './admin-alert.config';
...
const validationSchema = Joi.object({
  ...
  ADMIN_ALERT_SLACK_WEBHOOK_URL: Joi.string().uri().optional(),
  ADMIN_ALERT_COOLDOWN_MINUTES: Joi.number().integer().positive().default(30),
  ADMIN_ALERT_REDIS_FAILURE_THRESHOLD: Joi.number()
    .integer()
    .positive()
    .default(1),
  ADMIN_ALERT_STELLAR_FAILURE_THRESHOLD: Joi.number()
    .integer()
    .positive()
    .default(1),
