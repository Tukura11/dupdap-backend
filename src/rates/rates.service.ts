...
export class StaleRateException extends HttpException {
  constructor() {
    super('Rate data is stale (older than 5 minutes)', HttpStatus.SERVICE_UNAVAILABLE);
  }
}

const CACHE_KEY = 'rate:USDC:NGN';
const CACHE_TTL = 120;
